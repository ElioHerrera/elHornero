...
!function(i, h, m, f, d, k, e) {
    ...
    var b = i.$Jssor$ = new function() {
        ...
        j.Lg = function(d, a) {
            if (a)
                d.style.clip = "rect(" + c.$Round(a.$Top || a.J || 0) + "px " + c.$Round(a.$Right) + "px " + c.$Round(a.$Bottom) + "px " + c.$Round(a.$Left || a.N || 0) + "px)";
            else if (a !== e) {
        ...
        j.ig = function(b, a) {
            if (a)
                b.style.backgroundColor = "rgba(" + c.$Round(a.xd) + "," + c.$Round(a.wd) + "," + c.$Round(a.Bd) + "," + a.$Opacity + ")"
        }
        ;
        j.Ab = function() {
            return +new Date
        ...
        j.Ld = function(o, j, s, t, D, E, p) {
            ...
            if (a.$Clip && !a.$Clip.$Top && !a.$Clip.$Left && !a.$Clip.J && !a.$Clip.N && a.$Clip.$Right == p.$OriginalWidth && a.$Clip.$Bottom == p.$OriginalHeight)
                a.$Clip = f;
            return a
        }
    }
    ...
    i.$JssorSlideshowRunner$ = function(m, r, p, u, z, A) {
        ...
        function n(z, i, a, v, n, l) {
            var y = this, t, u = {}, h = {}, m = [], f, e, r, p = a.$ChessMode.$Column || 0, q = a.$ChessMode.$Row || 0, g = a.zf(n, l), o = B(a), C = o.length - 1, s = a.$Duration + a.$Delay * C, w = v + s, j = a.$SlideOut, x;
            w += 50;
            function B(a) {
                var b = a.$Formation(a);
    ...
    var t = i.$JssorCaptionSlideo$ = i.$JssorSlideo$ = function() {
      ...
      , j = i.$JssorSlider$ = (i.module || {}).exports = function() {
        ...
        function dd(r, h) {
            var g = this, ib = b.V(g, o), x, B = 0, V, jb = r, A = b.B(jb, "data-fillmode", m.$FillMode), F, u, z = [], T, K, P, O, i, n, y, Q;
            l.call(g, -N, N + 1, {
                pc: D & 1 ? q : e,
                $Reverse: Hb
            });
            ...
            b.c(c, function(a, d) {
                ...
                if (c == "loading")
                    ...
                    if (a.tagName != "STYLE" && a.tagName != "SCRIPT")
                        lc[c || d] = new Rc(a,c == "slides",b.ye(["slides", "thumbnavigator"])[c])
                }
            });
            R && b.nb(R);
            R = R || b.Tb(h);
